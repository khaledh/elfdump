type
  ...
  SectionType* = enum
    ...
    sctLlvmOdrTab   = (0x6fff4c00, "LLVM_ODR_TAB")
    sctLlvmLnkrOpts = (0x6fff4c01, "LLVM_LINKER_OPTIONS")
    sctLlvmCallGrPr = (0x6fff4c02, "LLVM_CALL_GRAPH_PROFILE")
    sctLlvmAddrSig  = (0x6fff4c03, "LLVM_ADDR_SIG")
